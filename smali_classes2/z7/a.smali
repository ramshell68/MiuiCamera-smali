...
.field public static C:Landroid/util/SparseArray; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public static D:Landroid/util/SparseArray; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Ljava/lang/String;",
...
.field public static final a:Ljava/lang/String; = "CameraStatUtils"
...
.field public static s:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Ljava/lang/String;",
...
.field public static t:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Ljava/lang/String;",
...
.field public static u:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/SparseArray<",
            "Ljava/lang/String;",
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lz7/a;->e:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lz7/a;->f:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lz7/a;->g:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lz7/a;->h:Ljava/util/Map;

    const-wide/16 v0, 0x0

    sput-wide v0, Lz7/a;->i:J

    sput-wide v0, Lz7/a;->j:J

    sput-wide v0, Lz7/a;->k:J

    sput-wide v0, Lz7/a;->l:J
    ...
    sput-boolean v0, Lz7/a;->p:Z

    sput-boolean v0, Lz7/a;->q:Z
    ...
    sput-object v1, Lz7/a;->r:Ljava/lang/Long;

    new-instance v1, Landroid/util/SparseArray;

    invoke-direct {v1}, Landroid/util/SparseArray;-><init>()V

    sput-object v1, Lz7/a;->s:Landroid/util/SparseArray;
    ...
    sget-object v1, Lz7/a;->s:Landroid/util/SparseArray;
    ...
    const-string v5, "M_film_exposuredelay_"
    ...
    const-string v5, "M_film_paralleldream_"
    ...
    const-string v5, "M_film_slow_shutter_"
    ...
    const-string v5, "M_film_time_backflow_"
    ...
    const-string v5, "M_film_time_freeze_"
    ...
    const-string v5, "M_film_dolly_zoom_"
    ...
    const-string v5, "M_ai_watermark_"
    ...
    const-string v5, "M_cosmetic_mirror_"
    ...
    sput-object v1, Lz7/a;->t:Landroid/util/SparseArray;

    const/16 v2, 0xa

    const-string v4, "shutter_button"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->t:Landroid/util/SparseArray;
    ...
    const-string v5, "speech_shutter"
    ...
    const-string v4, "suspend_shutter"
    ...
    sput-object v1, Lz7/a;->u:Landroid/util/SparseArray;

    const-string v2, "lowest"

    invoke-virtual {v1, v0, v2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->u:Landroid/util/SparseArray;
    ...
    sput-object v1, Lz7/a;->v:Landroid/util/SparseArray;

    const-string v2, "auto"

    invoke-virtual {v1, v0, v2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->v:Landroid/util/SparseArray;
    ...
    sput-object v1, Lz7/a;->w:Ljava/util/HashMap;
    ...
    sget-object v1, Lz7/a;->w:Ljava/util/HashMap;
    ...
    const-string v2, "attr_enlarge_eye"
    ...
    const-string v6, "attr_butt_slim"
    ...
    const-string v6, "attr_makeup_none"
    ...
    const-string v6, "attr_makeup_nude"
    ...
    const-string v6, "attr_makeup_toughman"
    ...
    const-string v6, "attr_makeup_gentleman"
    ...
    const-string v6, "attr_female_pink"
    ...
    const-string v6, "attr_female_blue"
    ...
    const-string v6, "attr_makeup_solid"
    ...
    const-string v6, "attr_skincolor_back"
    ...
    const-string v6, "attr_skincolor_off"
    ...
    const-string v6, "attr_skincolor_caramel"
    ...
    const-string v6, "attr_skincolor_wheat"
    ...
    const-string v6, "attr_skincolor_milktea"
    ...
    const-string v6, "attr_skincolor_white"
    ...
    const-string v6, "attr_skincolor_pink"
    ...
    const-string v6, "attr_skincolor_peach"
    ...
    const-string v6, "attr_skincolor_lotus"
    ...
    const-string v6, "attr_skincolor_matte"
    ...
    const-string v6, "attr_click_none"
    ...
    const-string v6, "attr_click_mauve"
    ...
    const-string v6, "attr_click_gust"
    ...
    const-string v6, "attr_click_beam"
    ...
    const-string v6, "attr_click_flare"
    ...
    sput-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_smooth_ratio"

    invoke-virtual {v1, v8, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_shrink_face_ratio"

    invoke-virtual {v1, v10, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_enlarge_eye_ratio"

    invoke-virtual {v1, v9, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_whole_body_slim"

    invoke-virtual {v1, v15, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_leg_slim"

    invoke-virtual {v1, v14, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_head_slim"

    invoke-virtual {v1, v11, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_body_slim"

    invoke-virtual {v1, v12, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->x:Ljava/util/HashMap;

    const-string v2, "attr_mi_live_shoulder_slim"
    ...
    sput-object v1, Lz7/a;->y:Ljava/util/HashMap;

    invoke-static {v0}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v2

    const-string v6, "torch_warm"

    invoke-virtual {v1, v2, v6}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->y:Ljava/util/HashMap;

    invoke-static {v3}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v2

    const-string v6, "torch_natural"
    ...
    const-string v2, "torch_cool"

    const-string v6, "torch_candle"

    const-string v5, "torch_warm"

    const-string v4, "torch_warm_natural"

    filled-new-array {v6, v5, v4, v1, v2}, [Ljava/lang/String;

    move-result-object v1

    sput-object v1, Lz7/a;->z:[Ljava/lang/String;
    ...
    sput-object v1, Lz7/a;->A:[Ljava/lang/String;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    sput-object v1, Lz7/a;->B:Ljava/util/HashMap;

    const-string v2, "attr_beauty_level"

    invoke-virtual {v1, v7, v2}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    sget-object v1, Lz7/a;->B:Ljava/util/HashMap;
    ...
    const-string v4, "attr_click_skin_color"
    ...
    const-string v4, "attr_click_select_skincolor"
    ...
    const-string v4, "attr_click_solid"
    ...
    const-string v4, "attr_click_whiten"
    ...
    const-string v4, "attr_click_risorius"
    ...
    const-string v4, "attr_click_lips"
    ...
    const-string v4, "attr_click_chin"
    ...
    const-string v4, "attr_click_neck"
    ...
    const-string v4, "attr_click_smile"
    ...
    const-string v4, "attr_click_slim_nose"
    ...
    const-string v4, "attr_click_hairline"
    ...
    const-string v4, "attr_click_headsize"
    ...
    const-string v4, "attr_click_nasaltip"
    ...
    const-string v4, "attr_click_temples"
    ...
    const-string v4, "attr_click_cheekbones"
    ...
    const-string v4, "attr_click_lowerjaw"
    ...
    const-string v4, "attr_click_hair"
    ...
    const-string v4, "attr_click_makeup_none"
    ...
    const-string v4, "attr_click_makeup_nude"
    ...
    const-string v4, "attr_click_makeup_toughman"
    ...
    const-string v4, "attr_click_makeup_gentleman"
    ...
    const-string v4, "attr_click_female_pink"
    ...
    const-string v4, "attr_click_female_blue"
    ...
    const-string v4, "attr_click_makeup_solid"
    ...
    const-string v4, "attr_click_eyeshade"
    ...
    const-string v4, "attr_click_teen"
    ...
    const-string v4, "attr_click_icequeen"
    ...
    const-string v4, "attr_click_myq"
    ...
    const-string v4, "attr_click_mll"
    ...
    const-string v4, "attr_click_lts"
    ...
    const-string v4, "attr_click_skincolor_back"
    ...
    const-string v4, "attr_click_skincolor_off"
    ...
    const-string v4, "attr_click_skincolor_caramel"
    ...
    const-string v4, "attr_click_skincolor_wheat"
    ...
    const-string v4, "attr_click_skincolor_milktea"
    ...
    const-string v4, "attr_click_skincolor_white"
    ...
    const-string v4, "attr_click_skincolor_pink"
    ...
    const-string v4, "attr_click_skincolor_peach"
    ...
    const-string v4, "attr_click_skincolor_lotus"
    ...
    const-string v4, "attr_click_skincolor_matte"
    ...
    const-string v4, "attr_click_none"
    ...
    const-string v4, "attr_click_mauve"
    ...
    const-string v4, "attr_click_sapphire"
    ...
    const-string v4, "attr_click_beam"
    ...
    const-string v4, "attr_click_flare"
    ...
    sput-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->O9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_blackgold"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->I9:Lm2/f;
    ...
    sget-object v2, Lm2/f;->J9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_film"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->A9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_original"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->B9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_holiday"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->C9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_oxygen"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->D9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_mint"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->G9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_pink_orange"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->ja:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "m_nude_makeup"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->ka:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "m_sweet_makeup"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->la:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "m_cool_makeup"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->ma:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "m_neutral_makeup"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->na:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "m_hardline_makeup"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->oa:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "m_soft_makeup"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->L9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_nature"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->K9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_japanese"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->M9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_pink"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->H9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_lively"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Q9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_classic"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->P9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_whiteAndBlack"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->d:Lm2/f;
    ...
    sget-object v2, Lm2/f;->n:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A11_SNOW"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->o:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A12_SEA"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->p:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A13_AUTUMN"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->q:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A14_CANDLELIGHT"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->r:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A15_CAR"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->t:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A16_GRASS"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->u:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A17_MAPLE_LEAVES"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->w:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A18_SUCCULENT"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->x:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A19_BUILDING"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->y:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A20_CITY"
    ...
    const-string v4, "A21_CLOUD"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Z:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A22_OVERCAST"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->k0:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A23_BACKLIGHT"
    ...
    const-string v4, "A24_SILHOUETTE"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->k1:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A25_HUMAN"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->p1:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A26_JEWELRY"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->q1:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A27_BUDDHA"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->v1:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A28_COW"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->C1:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A29_CURRY"
    ...
    const-string v4, "A31_TEMPLE"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->p2:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A32_BEACH"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->q2:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "A33_DRIVING"
    ...
    const-string v4, "bi_sunny"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Ua:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "bi_pink"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Va:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "bi_strong"
    ...
    const-string v4, "n_kp_160"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Qa:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "n_fc_400"
    ...
    const-string v4, "n_kg_200"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Wa:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "bi_m_dusk"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Xa:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "bi_m_tea"
    ...
    const-string v4, "v_northern_europe"
    ...
    const-string v4, "v_blackgold"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->ya:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "v_orange"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->za:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "v_cyberpink"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->Aa:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "v_blackice"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->E9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "male_cold"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->F9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "male_young"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->r9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "cv_nat"
    ...
    const-string v4, "cv_viv"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->s9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "cv_bwnat"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->t9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "cv_bwHC"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->u9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "cv_sepia"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->v9:Lm2/f;

    invoke-virtual {v2}, Ljava/lang/Enum;->ordinal()I

    move-result v2

    const-string v4, "cv_blue"

    invoke-virtual {v1, v2, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v1, Lz7/a;->C:Landroid/util/SparseArray;

    sget-object v2, Lm2/f;->W9:Lm2/f;
    ...
    sput-object v1, Lz7/a;->D:Landroid/util/SparseArray;

    const-string v2, "Super slow"

    invoke-virtual {v1, v0, v2}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v0, Lz7/a;->D:Landroid/util/SparseArray;
    ...
    sput-object v0, Lz7/a;->G:Ljava/util/HashMap;
    ...
    sget-object v0, Lz7/a;->G:Ljava/util/HashMap;
...
.method public static A(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v1}, Lz7/a;->u(I)Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lz7/a;->J(Ljava/util/Map;Z)V
    ...
    :cond_1
    invoke-static {p0, v0}, Lz7/e;->m(Ljava/lang/String;Ljava/util/Map;)V

    return-void
.end method

.method public static A0(Ljava/util/Map;)V
    .locals 1
    ...
    invoke-static {v0, p0}, Lz7/a;->D(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static A2()V
    ...
    invoke-static {v4, v0}, Lz7/e;->i(Ljava/lang/String;Ljava/util/Map;)V
    ...
    :cond_1
    invoke-static {v6}, Lz7/a;->C(I)Ljava/lang/String;
    ...
    invoke-static {v5, v7}, Lz7/e;->i(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v3}, Lz7/a;->C(I)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, Lz7/e;->i(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static A3(ILjava/lang/String;)V
    .locals 2
...
.method public static B0(Ljava/util/Map;)V
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-static {v0, p0}, Lz7/a;->F(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static B1(ILjava/lang/String;)V
    ...
    invoke-static {v0, p1}, Lz7/a;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
...
.method public static B2()V
    ...
    invoke-static {v1}, Lz7/a;->C(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lz7/a;->C(I)Ljava/lang/String;

    move-result-object v0

    const/4 v2, 0x0

    invoke-static {v1, v0, v2}, Lz7/a;->e(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static B3(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
...
.method public static C(I)Ljava/lang/String;
    ...
    sget-object v0, Lz7/a;->s:Landroid/util/SparseArray;
...
.method public static C1(Ljava/util/Map;Li8/a;I)V
    .locals 1
...
.method public static C2(Ljava/util/Map;Z)V
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
...
.method public static D1(II)V
    ...
    invoke-static {p0}, Lz7/a;->l(I)Ljava/lang/String;

    move-result-object p0

    invoke-static {p1, v0, p0}, Lz7/a;->H(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static E0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lu0/d1;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public static E1(Ljava/lang/String;Ljava/lang/String;I)V
    .locals 2
...
.method public static E3(Ljava/util/Map;Lz7/a$c;)V
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    iget-boolean v0, p1, Lz7/a$c;->i:Z
    ...
    :goto_0
    iget-boolean p1, p1, Lz7/a$c;->g:Z
...
.method public static E4(I)Ljava/lang/String;
    .locals 1

    sget-object v0, Lz7/a;->t:Landroid/util/SparseArray;
...
.method public static F(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p1, v1}, Lz7/a;->J(Ljava/util/Map;Z)V
...
.method public static F2(Ljava/lang/String;Ljava/lang/String;III)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static F4(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
...
.method public static G(ILjava/lang/String;Ljava/lang/Object;)V
    .locals 0

    invoke-static {p0}, Lz7/a;->u(I)Ljava/lang/String;

    move-result-object p0

    invoke-static {p0, p1, p2}, Lz7/a;->H(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static H(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1}, Lz7/a;->J(Ljava/util/Map;Z)V

    const-string p1, "key_common"

    invoke-static {p1, p0}, Lz7/e;->m(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static H2(Ljava/lang/String;IIIJLjava/lang/String;I)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-static {p0}, Lz7/a;->N(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    invoke-static {p7, v0}, Lz7/a;->V3(ILjava/util/Map;)V
...
.method public static H3(J)V
    ...
    invoke-static {p0, p1, v1}, Lz7/a;->L(JI)J
    ...
    sput-wide p0, Lz7/a;->l:J

    return-void
.end method

.method public static I(IZLjava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(IZ",
    ...
    invoke-static {p0}, Lcom/android/camera/a3;->T2(I)Z
    ...
    const-string p1, "attr_audio_gain_adjustment"
...
.method public static I1(Ljava/util/Map;ZZIIZILcom/android/camera/fragment/beauty/c0;Lcom/android/camera/h4;Ljava/lang/String;)V
    .locals 17
    ...
    :cond_0
    invoke-static/range {p3 .. p3}, Lz7/a;->C(I)Ljava/lang/String;
    ...
    invoke-static/range {p4 .. p4}, Lz7/a;->E4(I)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lx0/g1;->f0()Lx0/c1;

    move-result-object v7

    if-eqz v7, :cond_1

    invoke-virtual {v7, v1}, Lcom/android/camera/data/data/b;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v8, v9, v10}, Lcom/android/camera/data/data/f;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v8, v9, v11}, Lcom/android/camera/data/data/f;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lu0/h1;->T()Lu0/k;

    move-result-object v11

    if-eqz v11, :cond_5

    invoke-virtual {v11, v1}, Lu0/k;->getComponentValue(I)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v0, v11}, Lz7/a;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v10}, Lcom/android/camera/effect/n;->getEffectForSaving(Z)I
    ...
    :cond_8
    invoke-static {v3}, Lz7/a;->j(I)Ljava/lang/String;
    ...
    invoke-static {v15}, Lcom/android/camera/a3;->c7(Ljava/lang/String;)Z
    ...
    :cond_9
    invoke-static/range {v16 .. v16}, Lcom/android/camera/a3;->c7(Ljava/lang/String;)Z
    ...
    invoke-virtual/range {p7 .. p7}, Lcom/android/camera/fragment/beauty/c0;->g()Z
    ...
    invoke-virtual {v10}, Lu0/h1;->F()Lu0/t;

    move-result-object v10

    invoke-virtual {v10, v1}, Lu0/t;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-static {v2, v0}, Lz7/a;->b(ZLjava/util/Map;)V

    invoke-static/range {p1 .. p1}, Lcom/android/camera/a3;->i0(Z)Lcom/android/camera/j3;
    ...
    invoke-virtual {v10}, Lx0/g1;->s1()Z
    ...
    invoke-static {v10, v1, v0}, Lz7/a;->e3(IILjava/util/Map;)V

    :cond_11
    :goto_9
    invoke-static/range {p3 .. p3}, Lcom/android/camera/a3;->u1(I)F

    move-result v10

    const-string v15, "attr_zoom_ratio"

    invoke-static {v10}, Lm9/a;->z(F)Ljava/lang/String;
    ...
    invoke-virtual/range {p8 .. p8}, Lcom/android/camera/h4;->e()Z

    move-result v10

    invoke-virtual {v5}, Lu0/h1;->U()Lu0/m;
    ...
    invoke-virtual {v5, v1}, Lu0/m;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v4}, Lx0/g1;->F()Lx0/k;

    move-result-object v5

    invoke-virtual {v5}, Lx0/k;->i()Z
    ...
    invoke-virtual {v4, v1}, Lx0/k;->h(I)Z

    move-result v4

    if-eqz v4, :cond_17

    const-string v4, "pro_color_on"

    goto :goto_c

    :cond_17
    const-string v4, "pro_color_off"

    :goto_c
    const-string v5, "attr_pro_color_state"
    ...
    invoke-static/range {p3 .. p3}, Lcom/android/camera/a3;->N4(I)Z
    ...
    :cond_24
    invoke-static/range {p0 .. p0}, Lz7/a;->m1(Ljava/util/Map;)V

    invoke-static {}, Lub/c;->r2()Lub/c;

    move-result-object v4

    invoke-virtual {v4}, Lub/c;->k0()I
    ...
    :cond_2a
    invoke-static {v0, v2}, Lz7/a;->J(Ljava/util/Map;Z)V

    invoke-static {}, Lub/c;->r2()Lub/c;

    move-result-object v3

    invoke-virtual {v3}, Lub/c;->Lb()Z
    ...
    invoke-static {v3}, Lcom/android/camera2/g;->x7(Lcom/android/camera2/f;)Z

    move-result v4

    if-eqz v4, :cond_2d

    invoke-static {v3, v1}, Lcom/android/camera2/g;->y7(Lcom/android/camera2/f;I)Z
    ...
    :goto_1b
    const-string v4, "attr_super_clear_face_status"

    invoke-interface {v0, v4, v3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_2d
    invoke-static/range {p3 .. p3}, Lz7/a;->n(I)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v0}, Lz7/a;->I(IZLjava/util/Map;)V
...
.method public static I3(ZZIJ)V
    .locals 0

    sput-wide p3, Lz7/a;->l:J

    sput-boolean p0, Lz7/a;->p:Z

    sput-boolean p1, Lz7/a;->q:Z
...
.method public static K(Ls6/c1;Ljava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-virtual {v0, p0}, Lx0/e1;->l(I)Lcom/android/camera2/compat/theme/custom/mm/beauty/VideoLogLutWorkSpace;
...
.method public static K2()V
    ...
    invoke-static {v1, v0}, Lz7/e;->j(Ljava/lang/String;Ljava/lang/Object;)V

    return-void
.end method

.method public static K3(IIZJ)V
    .locals 0

    sput-wide p3, Lz7/a;->k:J
...
.method public static L2(ZZ)V
    ...
    invoke-static {v0, p0}, Lz7/a;->J(Ljava/util/Map;Z)V
...
.method public static L3(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Lz7/e;->i(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static M1(ILjava/lang/String;)V
    .locals 1
...
.method public static M2(Lhd/z;)V
    .locals 10

    if-eqz p0, :cond_5

    invoke-virtual {p0}, Lhd/z;->l()Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v4, Lz7/a;->r:Ljava/lang/Long;
    ...
    :cond_2
    sget-object v4, Ly9/ar;->p0:Ly9/br;

    invoke-static {v0, v4}, Ly9/cr;->i(Landroid/hardware/camera2/impl/CameraMetadataNative;Ly9/br;)Ljava/lang/Object;
    ...
    invoke-static {v0, v1}, Lz7/a;->Y2(Landroid/hardware/camera2/impl/CameraMetadataNative;Ljava/util/Map;)V

    invoke-virtual {p0}, Lhd/a0;->k0()I
    ...
    invoke-static {p0, v1}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static M3(JZI)V
    ...
    invoke-static {p0, p1, p3}, Lz7/a;->L(JI)J
    ...
    invoke-static {p0, p2}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static N1(Ljava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :goto_0
    invoke-static {p0, v0}, Lz7/a;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v1}, Lcom/android/camera/effect/n;->getEffectForSaving(Z)I

    move-result v0

    const-string v1, "attr_filter"

    invoke-static {v0}, Lz7/a;->j(I)Ljava/lang/String;
...
.method public static N3(J)V
    .locals 4

    sget-object v0, Lz7/a;->f:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-wide v1, Lz7/a;->j:J
    ...
    invoke-static {p0, p1, v3}, Lz7/a;->L(JI)J
...
.method public static O(I)Ljava/lang/String;
    ...
    :cond_0
    sget-object p0, Lz7/a;->D:Landroid/util/SparseArray;
...
.method public static O1(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 2
    ...
    invoke-static {p3}, Lz7/a;->C(I)Ljava/lang/String;
...
.method public static O2(Ljava/util/Map;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;II)V
    .locals 2
    ...
    invoke-static {p2}, Lz7/a;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lz7/a;->l(I)Ljava/lang/String;
    ...
    invoke-static {p3}, Lz7/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p4}, Lz7/a;->x(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p3

    invoke-interface {p0, p2, p3}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p7, p0}, Lz7/a;->V3(ILjava/util/Map;)V

    invoke-static {}, Lcom/android/camera/effect/n;->getInstance()Lcom/android/camera/effect/n;

    move-result-object p2

    invoke-virtual {p2}, Lcom/android/camera/effect/n;->isNeedDrawPeaking()Z
    ...
    invoke-virtual {p2}, Lcom/android/camera/effect/n;->isNeedDrawExposure()Z
    ...
    invoke-virtual {p2, p5, v0}, Lcom/android/camera/data/data/f;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p2, p5, v1}, Lcom/android/camera/data/data/f;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p6}, Lcom/android/camera/a3;->u1(I)F

    move-result p3

    const-string p4, "attr_zoom_ratio"

    invoke-static {p3}, Lm9/a;->z(F)Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lu0/h1;->G()Lu0/u;

    move-result-object p3

    const/16 p4, 0xa7

    invoke-virtual {p3, p4}, Lu0/u;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lu0/h1;->E()Lu0/q;

    move-result-object p3

    invoke-virtual {p3, p4}, Lu0/q;->k(I)Ljava/lang/String;
    ...
    invoke-static {p7, p6, p0}, Lz7/a;->e3(IILjava/util/Map;)V

    invoke-static {p0}, Lz7/a;->a(Ljava/util/Map;)V

    invoke-static {}, Lcom/android/camera/effect/n;->getInstance()Lcom/android/camera/effect/n;

    move-result-object p1

    invoke-virtual {p1, v0}, Lcom/android/camera/effect/n;->getEffectForSaving(Z)I

    move-result p1

    const-string p3, "attr_filter"

    invoke-static {p1}, Lz7/a;->j(I)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lu0/h1;->Y()Lu0/j0;
    ...
    invoke-virtual {p3}, Lu0/h1;->d0()Lu0/u0;

    move-result-object p3

    invoke-virtual {p3, p2}, Lcom/android/camera/data/data/b;->getValueDisplayStringNotFromResource(I)Ljava/lang/String;
    ...
    invoke-virtual {p4}, Lu0/h1;->c0()Lu0/t0;

    move-result-object p4

    invoke-virtual {p4, p2}, Lcom/android/camera/data/data/b;->getValueDisplayStringNotFromResource(I)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lu0/h1;->f0()Lcom/android/camera2/compat/theme/custom/mm/data/ComponentManuallyTone;
    ...
    invoke-virtual {p3}, Lu0/h1;->W()Lcom/android/camera2/compat/theme/custom/mm/data/ComponentManuallyColorSubTemperature;

    move-result-object p3

    invoke-virtual {p3, p2}, Lcom/android/camera/data/data/b;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {p4}, Lu0/h1;->X()Lcom/android/camera2/compat/theme/custom/mm/data/ComponentManuallyColorSubTune;

    move-result-object p4

    invoke-virtual {p4, p2}, Lcom/android/camera/data/data/b;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {p5}, Lu0/h1;->e0()Lcom/android/camera2/compat/theme/custom/mm/data/ComponentManuallyTexture;

    move-result-object p5

    invoke-virtual {p5, p2}, Lcom/android/camera/data/data/b;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {p6}, Lu0/h1;->g0()Lcom/android/camera2/compat/theme/custom/mm/data/ComponentManuallyVibrance;

    move-result-object p6

    invoke-virtual {p6, p2}, Lcom/android/camera/data/data/b;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-static {p6}, Lz7/a;->h(I)Ljava/lang/String;

    move-result-object p6

    const-string p7, "attr_tone"
    ...
    const-string p7, "attr_color_warm"
    ...
    const-string p7, "attr_detail_texture"
    ...
    invoke-static {p2}, Lz7/a;->h(I)Ljava/lang/String;

    move-result-object p2

    const-string p6, "attr_detail_vibrance"
    ...
    const-string p6, "pref_camera_first_style_official_used_key"

    invoke-virtual {p2, p6, v0}, Lcom/android/camera/data/data/f;->getBoolean(Ljava/lang/String;Z)Z
    ...
    sget-object p1, Lcom/android/camera2/compat/theme/custom/mm/manually/PictureStyleWorkspace;->OFFICIAL_CLASSIC:[Ljava/lang/String;
    ...
    :cond_7
    sget-object p1, Lcom/android/camera2/compat/theme/custom/mm/manually/PictureStyleWorkspace;->OFFICIAL_BLUE:[Ljava/lang/String;
    ...
    const-string p1, "soft_blues"

    goto :goto_4

    :cond_8
    sget-object p1, Lcom/android/camera2/compat/theme/custom/mm/manually/PictureStyleWorkspace;->OFFICIAL_CONTRAST:[Ljava/lang/String;
    ...
    :goto_5
    invoke-static {v0, p0}, Lz7/a;->b(ZLjava/util/Map;)V

    const-string p1, "M_manual_"

    invoke-static {p1, p0}, Lz7/a;->D(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static O3(JZI)V
    ...
    sget-object p2, Lz7/a;->f:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    sput-wide p0, Lz7/a;->j:J
...
.method public static P0(Lcom/xiaomi/fenshen/FenShenCam$Mode;Lcom/xiaomi/fenshen/FenShenCam$Message;)V
    .locals 2
...
.method public static P2(Ljava/util/Map;Landroid/content/Context;Lcom/android/camera/fragment/beauty/c0;I)V
    .locals 1

    if-eqz p2, :cond_0

    iget p2, p2, Lcom/android/camera/fragment/beauty/c0;->d:I
...
.method public static P3(J)V
    ...
    sget-object v0, Lz7/a;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    sget-wide v1, Lz7/a;->i:J
...
.method public static Q0(Lcom/xiaomi/fenshen/FenShenCam$Mode;ILjava/lang/String;)V
    .locals 3
...
.method public static Q2(Ljava/lang/String;Lcom/android/camera/fragment/beauty/c0;)V
    .locals 2
    ...
    iget p0, p1, Lcom/android/camera/fragment/beauty/c0;->d:I
...
.method public static Q3(JZI)V
    ...
    sget-object p2, Lz7/a;->e:Ljava/lang/Object;

    monitor-enter p2

    :try_start_0
    sput-wide p0, Lz7/a;->i:J
...
.method public static R(IILandroid/content/res/Resources;)V
    .locals 0
    ...
    invoke-static {p0, p1, p2}, Lz7/a;->e(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static R1(Ljava/lang/String;I)V
    .locals 1
    ...
    invoke-static {p0}, Lz7/a;->x(Ljava/lang/String;)Ljava/lang/String;
...
.method public static S(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v0}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V

    invoke-static {p0}, Lz7/a;->T(Ljava/lang/String;)V
...
.method public static S3(IFIZI)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static T0()V
    ...
    invoke-static {v1, v0}, Lz7/e;->i(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static U1(Ljava/lang/String;I)V
    .locals 1
...
.method public static V0(Ljava/util/Map;)V
    .locals 3
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static V1(ILjava/lang/String;)V
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-static {p0, v0, p1}, Lz7/a;->H(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static V2(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-static {p0, v0}, Lz7/e;->j(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static V3(ILjava/util/Map;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
...
.method public static W(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-static {p2}, Lz7/a;->f(I)Ljava/lang/String;
...
.method public static W1(Ljava/lang/String;Ljava/util/Map;)V
    .locals 1
    ...
    invoke-static {p0, p1}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static Y2(Landroid/hardware/camera2/impl/CameraMetadataNative;Ljava/util/Map;)V
    .locals 3
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-static {p0, v0}, Ly9/cr;->i(Landroid/hardware/camera2/impl/CameraMetadataNative;Ly9/br;)Ljava/lang/Object;
    ...
    invoke-static {p0, v1}, Ly9/cr;->i(Landroid/hardware/camera2/impl/CameraMetadataNative;Ly9/br;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Ljava/lang/Integer;

    sget-object v2, Ly9/ar;->o2:Ly9/br;

    invoke-static {p0, v2}, Ly9/cr;->i(Landroid/hardware/camera2/impl/CameraMetadataNative;Ly9/br;)Ljava/lang/Object;
...
.method public static Y3(ZZZZ)V
    .locals 2
...
.method public static Z1(Ljava/util/Map;I)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static Z2(Ls6/c1;I)V
    .locals 5
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "supportProVideo"
    ...
    invoke-static {v1}, Lz7/a;->F4(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ls6/c1;->J()Ljava/lang/String;

    move-result-object v2

    invoke-interface {v0, v1, v2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p0}, Ls6/c1;->c0()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lz7/a;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lz7/a;->l(I)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ls6/c1;->L()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lz7/a;->g(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Ls6/c1;->V()Ljava/lang/String;

    move-result-object v1

    invoke-static {v1}, Lz7/a;->x(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lz7/a;->V3(ILjava/util/Map;)V

    invoke-static {}, Lcom/android/camera/effect/n;->getInstance()Lcom/android/camera/effect/n;

    move-result-object p1

    invoke-virtual {p1}, Lcom/android/camera/effect/n;->isNeedDrawPeaking()Z
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/n;->isNeedDrawExposure()Z
    ...
    invoke-virtual {p1, v3, v4}, Lcom/android/camera/data/data/f;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1, v3, v4}, Lcom/android/camera/data/data/f;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lu0/h1;->E()Lu0/q;
    ...
    invoke-virtual {p1, v4}, Lu0/q;->k(I)Ljava/lang/String;
    ...
    invoke-static {p1, v4, v0}, Lz7/a;->e3(IILjava/util/Map;)V

    invoke-static {v0}, Lz7/a;->a(Ljava/util/Map;)V
    ...
    const-string p1, "attr_video_surround_sound"
    ...
    invoke-virtual {p0}, Ls6/c1;->R()Z

    move-result v3

    invoke-static {p1, v3, v0}, Lz7/a;->I(IZLjava/util/Map;)V

    invoke-virtual {p0}, Ls6/c1;->P()Ljava/lang/String;
    ...
    :cond_15
    invoke-static {p0, v0}, Lz7/a;->K(Ls6/c1;Ljava/util/Map;)V

    invoke-virtual {p0}, Ls6/c1;->D()Ljava/lang/String;
    ...
    const-string p1, "attr_variable_aperture"
    ...
    invoke-static {p0, v0}, Lz7/a;->D(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static Z3(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
...
.method public static a(Ljava/util/Map;)V
    ...
    invoke-static {v1}, Lcom/android/camera2/g;->T0(Lcom/android/camera2/f;)I
    ...
    invoke-virtual {v2}, Lu0/h1;->k0()Lu0/y;

    move-result-object v2

    invoke-virtual {v2}, Lu0/y;->x()Z
...
.method public static a1(I)V
    ...
    invoke-static {v0, v1, p0}, Lz7/a;->H(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public static b(ZLjava/util/Map;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
...
.method public static b2(ILjava/lang/String;)V
    .locals 1
    ...
    const-string p0, "attr_switch_macro"
...
.method public static b3(Lz7/a$b;)V
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isRemoteOnlineSupported"
    ...
    invoke-interface {p0, v0}, Lz7/a$b;->a(Ljava/util/Map;)V
...
.method public static c2(I)V
    ...
    invoke-virtual {v0, v1, p0}, Lx0/g1;->t1(II)Z
    ...
    invoke-static {p0}, Lcom/android/camera/o6;->r2(F)Ljava/lang/String;
...
.method public static c3(Ljava/lang/String;I)V
    .locals 2
...
.method public static c4(Ljava/lang/String;Z)V
    .locals 2
...
.method public static d(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lz7/a;->f(I)Ljava/lang/String;
...
.method public static e(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :goto_0
    invoke-static {}, Lz7/a;->r()Ljava/lang/String;
...
.method public static e0(IJZI)V
    .locals 3
    ...
    invoke-static {p1, p2, p0}, Lz7/a;->L(JI)J
...
.method public static e1(Ljava/lang/String;Ljava/lang/String;)V
    .locals 4
    ...
    invoke-static {p0, v1}, Lz7/a;->E(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static e2(Ljava/lang/String;)V
    ...
    invoke-static {v0, p0, v1}, Lz7/a;->G(ILjava/lang/String;Ljava/lang/Object;)V

    return-void
.end method

.method public static e3(IILjava/util/Map;)V
    .locals 2
    ...
    invoke-static {p1}, Lz7/a;->p(I)Ljava/lang/String;
...
.method public static e4(Ljava/lang/String;)V
    .locals 2
...
.method public static f2()V
    ...
    invoke-static {v2, v0, v1}, Lz7/a;->G(ILjava/lang/String;Ljava/lang/Object;)V
...
.method public static g(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v3, Lz7/a;->v:Landroid/util/SparseArray;
...
.method public static g1(ILjava/lang/String;)V
    .locals 3
    ...
    :cond_0
    invoke-static {p0}, Lz7/a;->C(I)Ljava/lang/String;
...
.method public static h1(Ljava/lang/String;I)V
    .locals 1
...
.method public static h4(Ljava/lang/String;)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    sget-object v1, Lz7/a;->G:Ljava/util/HashMap;
...
.method public static i(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lz7/a;->u(I)Ljava/lang/String;
    ...
    invoke-static {v0, p1}, Lz7/a;->J(Ljava/util/Map;Z)V
...
.method public static i0(ZI)V
    ...
    const-string p0, "app_upgrade_version_code"
...
.method public static i3(Landroid/content/Intent;I)V
    .locals 4
    ...
    invoke-static {v2, v0}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/x2;->N()Z
...
.method public static i4(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isRemoteOnlineSupported"
...
.method public static j(I)Ljava/lang/String;
    ...
    sget-object v0, Lz7/a;->C:Landroid/util/SparseArray;
...
.method public static j0(I)V
    ...
    const-string v1, "app_upgrade_status"
...
.method public static j4(Ljava/lang/String;Z)V
    .locals 1
...
.method public static k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_d
    invoke-virtual {p1}, Lx0/x0;->l()I

    move-result p1

    invoke-static {p1}, Lz7/a;->t(I)Ljava/lang/String;
    ...
    sget-object v0, Lz7/a;->y:Ljava/util/HashMap;
...
.method public static k1(Ljava/lang/String;I)V
    ...
    invoke-static {p0}, Lz7/a;->g(Ljava/lang/String;)Ljava/lang/String;
...
.method public static k4(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
...
.method public static l(I)Ljava/lang/String;
    ...
    invoke-static {v0}, Lz7/a;->f(I)Ljava/lang/String;
...
.method public static l1(Landroid/view/KeyEvent;Ljava/lang/String;)V
    .locals 2
...
.method public static l3(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "useSlowMotionTab"
    ...
    invoke-static {p1}, Lz7/a;->N(Ljava/lang/String;)Ljava/lang/String;
...
.method public static m0(Ljava/lang/String;I)V
    ...
    invoke-static {p0}, Lz7/a;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method public static m1(Ljava/util/Map;)V
    .locals 2
...
.method public static m2(ILjava/lang/String;IIZLcom/android/camera/fragment/beauty/c0;ILjava/lang/String;)V
    .locals 5
    ...
    invoke-static {p6}, Lz7/a;->F4(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v1}, Lu0/f0;->getComponentValue(I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p2}, Lz7/a;->j(I)Ljava/lang/String;
    ...
    invoke-static {p3}, Lz7/a;->O(I)Ljava/lang/String;

    move-result-object p1

    invoke-interface {v0, p0, p1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {p5}, Lcom/android/camera/fragment/beauty/c0;->g()Z
    ...
    sget-object p0, Lz7/a;->x:Ljava/util/HashMap;
    ...
    invoke-virtual {p5, p1}, Lcom/android/camera/fragment/beauty/c0;->a(Ljava/lang/String;)I

    move-result p1

    invoke-static {p1}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    sget-object p1, Lp0/g;->i1:[Ljava/lang/String;
    ...
    sget-object p4, Lz7/a;->x:Ljava/util/HashMap;
    ...
    invoke-virtual {p5, p3}, Lcom/android/camera/fragment/beauty/c0;->a(Ljava/lang/String;)I

    move-result p3

    invoke-static {p3}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    :cond_7
    sget-object p1, Lp0/g;->a1:[Ljava/lang/String;
...
.method public static m3(ZI)V
    ...
    invoke-virtual {v1}, Lub/c;->S6()Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-virtual {v0, p1}, Lx0/g1;->y1(I)Z
...
.method public static m4(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
...
.method public static n(I)Ljava/lang/String;
    ...
    :catch_0
    invoke-virtual {v0}, Lu0/a1;->B()F

    move-result p0

    :goto_0
    invoke-virtual {v0, p0}, Lu0/a1;->v(F)Ljava/lang/String;
    ...
    invoke-virtual {v0, p0}, Lu0/a1;->w(I)Ljava/lang/String;
...
.method public static n0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :pswitch_0
    sget-object v2, Lz7/a;->B:Ljava/util/HashMap;
    ...
    :pswitch_2
    sget-object p0, Lz7/a;->B:Ljava/util/HashMap;
...
.method public static n4(Ljava/lang/String;ZLjava/lang/String;)V
    .locals 0
    ...
    invoke-static {p2}, Lz7/a;->F4(Ljava/lang/String;)Ljava/lang/String;
...
.method public static o0(ILjava/lang/String;Lcom/android/camera/fragment/beauty/c0;JI)V
    .locals 16
    ...
    :cond_0
    invoke-virtual/range {p2 .. p2}, Lcom/android/camera/fragment/beauty/c0;->g()Z
    ...
    :cond_2
    invoke-virtual {v3}, Lx0/u0;->y()Lcom/android/camera2/f;
    ...
    invoke-static {v4}, Lcom/android/camera2/g;->M3(Lcom/android/camera2/f;)Z
    ...
    sget-object v5, Lp0/g;->Z0:[Ljava/lang/String;
    ...
    sget-object v11, Lz7/a;->w:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v10}, Lcom/android/camera/fragment/beauty/c0;->a(Ljava/lang/String;)I

    move-result v10

    invoke-static {v10}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    :cond_6
    invoke-virtual {v3}, Lx0/u0;->m0()Z

    move-result v1

    if-eqz v1, :cond_8

    sget-object v1, Lp0/g;->d1:[Ljava/lang/String;
    ...
    sget-object v5, Lz7/a;->w:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v4}, Lcom/android/camera/fragment/beauty/c0;->a(Ljava/lang/String;)I

    move-result v4

    invoke-static {v4}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lcom/android/camera/fragment/beauty/c0;->a(Ljava/lang/String;)I

    move-result v3

    invoke-static {v3}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lx0/g1;->V()Lx0/q0;

    move-result-object v5

    invoke-virtual {v3}, Lx0/u0;->j0()Z
    ...
    invoke-virtual {v5, v1}, Lx0/q0;->h(I)Z
    ...
    :goto_2
    invoke-virtual {v3}, Lx0/u0;->B()Lcom/android/camera/fragment/beauty/l$a;

    move-result-object v9

    invoke-static {v4}, Lcom/android/camera2/g;->K9(Lcom/android/camera2/f;)Z
    ...
    invoke-virtual {v9}, Lcom/android/camera/fragment/beauty/l$a;->e()Ljava/util/List;
    ...
    check-cast v10, Lcom/android/camera/fragment/beauty/l$a$a;

    invoke-virtual {v10}, Lcom/android/camera/fragment/beauty/l$a$a;->b()I

    move-result v10

    invoke-static {v10}, Lcom/android/camera/fragment/beauty/l$a;->d(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera2/g;->B2(Lcom/android/camera2/f;)Z

    move-result v4

    if-eqz v4, :cond_d

    sget-object v4, Lp0/g;->c1:[Ljava/lang/String;

    goto :goto_4

    :cond_d
    sget-object v4, Lp0/g;->b1:[Ljava/lang/String;
    ...
    :cond_12
    sget-object v14, Lz7/a;->w:Ljava/util/HashMap;
    ...
    invoke-virtual {v0, v13}, Lcom/android/camera/fragment/beauty/c0;->a(Ljava/lang/String;)I

    move-result v13

    invoke-static {v13}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/android/camera/a3;->c7(Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Lcom/android/camera2/g;->k4(Lcom/android/camera2/f;)Z
    ...
    sget-object v10, Lz7/a;->w:Ljava/util/HashMap;
    ...
    invoke-static {v7}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    invoke-static {v4}, Lz7/a;->q(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5, v4, v9}, Lcom/android/camera/a3;->x(Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/fragment/beauty/l$a;)I

    move-result v5

    const-string v7, "attr_makeup_num"

    invoke-static {v5}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    :cond_1c
    invoke-virtual {v3}, Lx0/u0;->h0()Z

    move-result v3

    if-eqz v3, :cond_20

    invoke-static/range {p5 .. p5}, Lcom/android/camera/a3;->m(I)Ljava/lang/String;

    move-result-object v1

    sget-object v3, Lz7/a;->w:Ljava/util/HashMap;
    ...
    :cond_1d
    invoke-virtual/range {p2 .. p2}, Lcom/android/camera/fragment/beauty/c0;->d()Z

    move-result v1

    if-eqz v1, :cond_20

    sget-object v1, Lp0/g;->a1:[Ljava/lang/String;
    ...
    :cond_21
    iget v1, v0, Lcom/android/camera/fragment/beauty/c0;->c:I

    invoke-static {v1}, Lz7/a;->h(I)Ljava/lang/String;
    ...
    iget v1, v0, Lcom/android/camera/fragment/beauty/c0;->e:I
    ...
    iget v1, v0, Lcom/android/camera/fragment/beauty/c0;->b:I
    ...
    iget v1, v0, Lcom/android/camera/fragment/beauty/c0;->d:I
    ...
    invoke-static {v8, v2}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static o3(FZ)V
    ...
    invoke-static {p0}, Lm9/a;->z(F)Ljava/lang/String;
...
.method public static o4(Ls6/c1;)V
    .locals 10
    ...
    invoke-virtual {p0}, Ls6/c1;->Z()Ljava/lang/String;
    ...
    invoke-static {}, Lcom/android/camera/a3;->j2()I
    ...
    sget-object v2, Lz7/a;->y:Ljava/util/HashMap;
    ...
    invoke-static {v1, v2, v0}, Lz7/a;->e3(IILjava/util/Map;)V
    ...
    invoke-virtual {v1, v5}, Lx0/h0;->getComponentValue(I)Ljava/lang/String;
    ...
    :cond_7
    invoke-virtual {p0}, Ls6/c1;->G()Lcom/android/camera/fragment/beauty/c0;
    ...
    iget v1, v1, Lcom/android/camera/fragment/beauty/c0;->d:I
    ...
    :goto_5
    invoke-virtual {p0}, Ls6/c1;->B()[Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/android/camera/fragment/beauty/l$a;->j()Z

    move-result v1

    if-eqz v1, :cond_d

    invoke-static {v8}, Lcom/android/camera/a3;->n0(Ljava/lang/String;)I
    ...
    invoke-virtual {v1}, Lcom/android/camera/fragment/beauty/c0;->g()Z
    ...
    invoke-static {v1}, Lcom/android/camera/a3;->O6(I)Z
    ...
    invoke-static {v1}, Lcom/android/camera/a3;->T2(I)Z
    ...
    :goto_15
    const-string v5, "attr_ai_audio_single_video"
    ...
    invoke-static {v1}, Lcom/android/camera/a3;->U2(I)Z
    ...
    :goto_17
    const-string v5, "attr_ai_audio_new_video"
    ...
    invoke-static {v1}, Lz7/a;->P(I)Ljava/lang/String;
    ...
    invoke-virtual {v5, v8}, Lx0/j0;->getDefaultValue(I)Ljava/lang/String;

    move-result-object v5

    const-string v8, "pref_new_video_time_lapse_duration_key"

    invoke-virtual {v1, v8, v5}, Lcom/android/camera/data/data/f;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static p2(Ljava/lang/String;Ljava/lang/String;I)V
    .locals 2
...
.method public static p3(Z)V
    ...
    invoke-static {v0, p0}, Lz7/e;->i(Ljava/lang/String;Ljava/util/Map;)V

    return-void
.end method

.method public static p4(ZIIZZZLjava/lang/String;IIIILcom/android/camera/fragment/beauty/c0;JZ[Ljava/lang/String;ZZIZ)V
    .locals 5
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    invoke-virtual {v0, p0}, Ls6/c1$a;->r(Z)Ls6/c1$a;

    move-result-object v1

    move v2, p1

    invoke-virtual {v1, p1}, Ls6/c1$a;->b(I)Ls6/c1$a;

    move-result-object v1

    move v2, p2

    invoke-virtual {v1, p2}, Ls6/c1$a;->v(I)Ls6/c1$a;

    move-result-object v1

    move v3, p3

    invoke-virtual {v1, p3}, Ls6/c1$a;->p(Z)Ls6/c1$a;

    move-result-object v1

    move v3, p4

    invoke-virtual {v1, p4}, Ls6/c1$a;->s(Z)Ls6/c1$a;

    move-result-object v1

    move v3, p5

    invoke-virtual {v1, p5}, Ls6/c1$a;->t(Z)Ls6/c1$a;

    move-result-object v1

    move-object v3, p6

    invoke-virtual {v1, p6}, Ls6/c1$a;->y(Ljava/lang/String;)Ls6/c1$a;

    move-result-object v1

    move v3, p7

    invoke-virtual {v1, p7}, Ls6/c1$a;->A(I)Ls6/c1$a;

    move-result-object v1

    move v3, p8

    invoke-virtual {v1, p8}, Ls6/c1$a;->l(I)Ls6/c1$a;

    move-result-object v1

    move v3, p9

    invoke-virtual {v1, p9}, Ls6/c1$a;->m(I)Ls6/c1$a;

    move-result-object v1

    move v3, p10

    invoke-virtual {v1, p10}, Ls6/c1$a;->u(I)Ls6/c1$a;

    move-result-object v1

    move-object/from16 v3, p11

    invoke-virtual {v1, v3}, Ls6/c1$a;->g(Lcom/android/camera/fragment/beauty/c0;)Ls6/c1$a;

    move-result-object v1

    move-wide/from16 v3, p12

    invoke-virtual {v1, v3, v4}, Ls6/c1$a;->h(J)Ls6/c1$a;

    move-result-object v1

    move/from16 v3, p14

    invoke-virtual {v1, v3}, Ls6/c1$a;->w(Z)Ls6/c1$a;

    move-result-object v1

    move-object/from16 v3, p15

    invoke-virtual {v1, v3}, Ls6/c1$a;->c([Ljava/lang/String;)Ls6/c1$a;

    move-result-object v1

    move/from16 v3, p16

    invoke-virtual {v1, v3}, Ls6/c1$a;->q(Z)Ls6/c1$a;

    move-result-object v1

    move/from16 v3, p17

    invoke-virtual {v1, v3}, Ls6/c1$a;->e(Z)Ls6/c1$a;

    move-result-object v1

    move/from16 v3, p18

    invoke-virtual {v1, v3}, Ls6/c1$a;->f(I)Ls6/c1$a;

    move-result-object v1

    move/from16 v3, p19

    invoke-virtual {v1, v3}, Ls6/c1$a;->x(Z)Ls6/c1$a;

    move-result-object v1

    invoke-static {p2}, Lz7/a;->n(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2}, Ls6/c1$a;->d(Ljava/lang/String;)Ls6/c1$a;

    invoke-virtual {v0}, Ls6/c1$a;->a()Ls6/c1;

    move-result-object v0

    invoke-static {v0}, Lz7/a;->o4(Ls6/c1;)V
...
.method public static q0(Ljava/lang/String;)V
    ...
    invoke-static {v2, p0}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {v1}, Lz7/a;->S1(Ljava/lang/String;)V

    :goto_1
    invoke-static {p0}, Lcom/android/camera/fragment/beauty/l;->f(Ljava/lang/String;)Z
...
.method public static q1(Ljava/lang/String;Ljava/lang/String;I)V
    .locals 2
...
.method public static q2(Ljava/util/Map;Ljava/lang/String;ZZ)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lz7/a;->k(Ljava/util/Map;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p2}, Lz7/a;->E(Ljava/lang/String;Ljava/util/Map;)V
    ...
    const-class p3, Lig/y;

    invoke-virtual {p2, p3}, Lz0/a;->c(Ljava/lang/Class;)Lz0/d;
    ...
    invoke-static {p1, p0}, Lz7/a;->E(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static q3(Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lz7/a;->v(Ljava/lang/String;)Ljava/lang/String;
...
.method public static r1(Ljava/lang/String;Ljava/lang/String;IZ)V
    .locals 2
...
.method public static r2(Ljava/lang/String;Ljava/lang/String;)V
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Lz7/a;->s2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static r3(Z)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static r4(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
...
.method public static s(I)Ljava/lang/String;
    ...
    sget-object v0, Lz7/a;->A:[Ljava/lang/String;
...
.method public static s2(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
...
.method public static s4(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportFeatureVlogProMode"
...
.method public static t(I)Ljava/lang/String;
    ...
    sget-object v0, Lz7/a;->z:[Ljava/lang/String;
...
.method public static t3()V
    ...
    sget-object v0, Lz7/a;->g:Ljava/util/Map;
    ...
    sget-object v2, Lz7/a;->g:Ljava/util/Map;
    ...
    invoke-static {v3, v4, v0}, Lz7/a;->L(JI)J
    ...
    sget-object v1, Lz7/a;->g:Ljava/util/Map;

    invoke-static {v0, v1}, Lz7/a;->B(Ljava/lang/String;Ljava/util/Map;)V
...
.method public static t4(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 6
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportFeatureVlogProMode"
    ...
    invoke-static/range {v0 .. v5}, Lz7/a;->r4(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static u1(Ljava/lang/String;Z)V
    .locals 2
...
.method public static u3(IZ)V
    ...
    sget-object p0, Lz7/a;->g:Ljava/util/Map;
...
.method public static u4(Ljava/lang/String;)V
    .locals 3
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportFeatureVlogProMode"
    ...
    invoke-static {p0}, Lcom/android/camera/a3;->n0(Ljava/lang/String;)I
...
.method public static v0(Landroid/content/Intent;Ljava/lang/String;)V
    .locals 1
...
.method public static v2(Ljava/lang/String;ZZZZJ)V
    .locals 2
...
.method public static v3()V
    ...
    sget-object v0, Lz7/a;->h:Ljava/util/Map;
    ...
    sget-object v2, Lz7/a;->h:Ljava/util/Map;
    ...
    sget-object v1, Lz7/a;->h:Ljava/util/Map;
...
.method public static v4(Ljava/lang/String;Ljava/lang/String;)V
    .locals 6
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportFeatureVlogProMode"
...
.method public static w2(Ljava/lang/String;Ljava/util/Map;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static w3(IZ)V
    ...
    sget-object p0, Lz7/a;->h:Ljava/util/Map;
...
.method public static w4(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
        key = "isSupportThemeCV"
...
.method public static x3(Ljava/lang/String;Ljava/lang/String;Z)V
    .locals 2
...
.method public static y(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lz7/a;->z(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static y0()V
    ...
    invoke-static {v2, v3, v4}, Lcom/android/camera/o6;->B(III)I
    ...
    invoke-static {v1, v2, v3}, Lcom/android/camera/o6;->B(III)I
...
.method public static y4(Ljava/lang/String;Z)V
    .locals 1
    ...
    invoke-static {p0, p1, v0}, Lz7/a;->z4(Ljava/lang/String;ZF)V

    return-void
.end method

.method public static z(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-static {p3}, Lz7/a;->u(I)Ljava/lang/String;
...
.method public static z0(Ljava/util/Map;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static z1(IZ)V
    ...
    invoke-static {p0}, Lz7/a;->j(I)Ljava/lang/String;

    move-result-object p0

    const-string p1, "click"

    invoke-static {v0, p0, p1}, Lz7/a;->i(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;)V
...
.method public static z4(Ljava/lang/String;ZF)V
    .locals 2
    ...
    invoke-static {p0, p2}, Lcom/android/camera2/s3;->g(IF)F

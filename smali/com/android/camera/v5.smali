...
.method public static w(Ljava/io/File;Landroid/content/ContentResolver;)Lcom/android/camera/v5;
    .locals 16
    ...
    :try_start_0
    sget-object v5, Lcom/android/camera/v5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v5, v0}, Lcom/android/camera/o6;->C3(Landroid/net/Uri;Landroid/content/ContentResolver;)Z
    ...
    sget-object v2, Lcom/android/camera/v5;->s:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :cond_8
    invoke-static {v5, v0, v4, v4}, Lcom/android/camera/v5;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/v5;

    move-result-object v0

    if-eqz v0, :cond_9

    invoke-virtual {v0, v11}, Lcom/android/camera/v5;->O(Z)V

    invoke-virtual {v0, v12, v13}, Lcom/android/camera/v5;->N(II)V

    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lcom/android/camera/v5;->M(Z)V

    invoke-virtual {v0, v3}, Lcom/android/camera/v5;->P(Z)V

    invoke-virtual {v0, v14, v15}, Lcom/android/camera/v5;->L(J)V

    sget v2, Lcom/android/camera/v5;->w:I

    invoke-virtual {v0, v2}, Lcom/android/camera/v5;->R(I)V
